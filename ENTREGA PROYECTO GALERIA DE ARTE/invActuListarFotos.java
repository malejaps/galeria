/* CLASE					InvActuListarFotos
 * RESPONSABILIDAD			Mostrar el inventario actual de las fotos
...
public class invActuListarFotos extends JFrame {
    ...
    public invActuListarFotos (Fotografo fotografo) 
    {
    ...
    acercade.addActionListener(new ActionListener()
    {
    	...
    	public void actionPerformed( ActionEvent evento )
            {
              JOptionPane.showMessageDialog( invActuListarFotos.this,
   ...
   ayuda.addActionListener(new ActionListener()
    ...
    JMenuItem elementoSalir = new JMenuItem( "Salir Del programa" );
      ...
      barra.add( menuAyuda ); 
    	...
    	gal.listarFotosActual(fotografo);
