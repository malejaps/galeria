/* CLASE					invListarObras
 * RESPONSABILIDAD			Listar las obras de la galeria
* DESCRIPCION				Aplicacion que lista las obras de la galeria
...
import javax.swing.*;
public class invListarObras extends JFrame {
    ...
    public invListarObras (Artista artista) 
    {
    ...
    acercade.addActionListener(new ActionListener()
    {
    	...
    	public void actionPerformed( ActionEvent evento )
            {
              JOptionPane.showMessageDialog( invListarObras.this,
