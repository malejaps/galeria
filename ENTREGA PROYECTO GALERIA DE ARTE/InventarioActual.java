/* CLASE					InventarioActual
 * RESPONSABILIDAD			Mostrar el inventario actual de la galeria de arte
 * COLABORACION				Trabaja con las clases: Galeria, EgaleriaDeArte, invActuListarFotos, invActuListarObras, Inventario
 */
import java.awt.*;
...
public class InventarioActual extends JFrame {
    ...
    acercade.addActionListener(new ActionListener()
    {
    	...
    	public void actionPerformed( ActionEvent evento )
            {
              JOptionPane.showMessageDialog( InventarioActual.this,
   ...
   ayuda.addActionListener(new ActionListener()
    ...
    JMenuItem elementoSalir = new JMenuItem( "Salir Del programa" );
      ...
      barra.add( menuAyuda ); 
    	...
    	titulo3= new JLabel("INVENTARIO ACTUAL");
