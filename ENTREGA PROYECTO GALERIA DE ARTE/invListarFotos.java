/* CLASE					invListarFotos
 * RESPONSABILIDAD			Listar las fotos de la galeria
* DESCRIPCION				Aplicacion que lista las fotos de la galeria
 * COLABORACION				Trabaja con las clases: MenuGaleria, EgaleriaDeArte, Inventario
 */
...
public class invListarFotos extends JFrame {
    ...
    public invListarFotos (Fotografo fotografo) 
    {
    ...
    acercade.addActionListener(new ActionListener()
    {
    	...
    	public void actionPerformed( ActionEvent evento )
            {
              JOptionPane.showMessageDialog( invListarFotos.this,
   ...
   ayuda.addActionListener(new ActionListener()
    ...
    JMenuItem elementoSalir = new JMenuItem( "Salir Del programa" );
      ...
      barra.add( menuAyuda ); 
    	...
    	titulo= new JLabel("INVENTARIO DE FOTOS");
    	...
    	gal.listarFotos(fotografo);
    	Listar = new JComboBox();
    	//Listar.setMaximumRowCount(5);
    	Listar.setBounds(50,150,150,20);
    	
    	
    	ComboBoxModel elemento = new DefaultComboBoxModel(gal.fotos);
   ...
   { 
      invListarObras aplicacion = new invListarObras();
